...
namespace QtPackage
{
    ...
    internal sealed class SR 
    {
        ...
        internal SR() 
        {
            ...
            appCultureInfo = CultureInfo.GetCultureInfo(VSPackage.dte.LocaleID);
            if (appCultureInfo.Name.StartsWith("en"))
                appCultureInfo = null;
            //resources = new ResourceManager(typeof(Qt5Package2015.VSPackage));
            resources = new ResourceManager("VSPackage", System.Reflection.Assembly.GetExecutingAssembly());
        }
