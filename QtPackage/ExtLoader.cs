    ...
    public class ExtLoader {
        ...
        private static System.Diagnostics.Process getQtApplicationProcess( string applicationName,
            ...
            if ( !File.Exists( process.StartInfo.FileName )
                && HelperFunctions.GetSelectedQtProject( VSPackage.dte ) != null ) {   // Try to find apllication in project's Qt dir first
                string path = null;
                QtVersionManager vm = QtVersionManager.The();
                Project prj = HelperFunctions.GetSelectedQtProject( VSPackage.dte );
                if ( prj != null )
        ...
        public void loadDesigner( string fileName ) {
            ...
            if ( prj != null ) {
                ...
                prj = HelperFunctions.GetSelectedProject( VSPackage.dte );
        ...
        public static void loadQrcEditor( string file ) {
            ...
            try {
                ...
                tmp.StartInfo.FileName = VSPackage.qrcEditorPath;
